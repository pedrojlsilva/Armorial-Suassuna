...
void WorldMapUpdater::setDefaultFieldGeometry(WorldMap *wm, Competitions::Competition competition) {
    ...
    const float penaltyDist = (competition==Competitions::SSL? _defaultField->defenseRadius() : _defaultField->maxX()/2);
