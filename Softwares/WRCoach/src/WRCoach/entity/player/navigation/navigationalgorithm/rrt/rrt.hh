...
#include <WRCoach/entity/player/navigation/navigationalgorithm/rrt/rrttree.hh>
...
private:
    ...
    void removeObstaclesNear(const Position &pos);
    ...
    static float squareDistance(const Position &pos1, const Position &pos2);

    // Append and remove methods for path
