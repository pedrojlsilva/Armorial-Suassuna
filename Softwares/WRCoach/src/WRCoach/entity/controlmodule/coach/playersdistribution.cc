...
#include "playersdistribution.hh"
...
PlayersDistribution::PlayersDistribution(WRTeam *team, qint8 *kickerId, SSLGameInfo::RefProcessedState *lastState, SSLReferee *ref) {
    _team = team;
    _kickerId = kickerId;
