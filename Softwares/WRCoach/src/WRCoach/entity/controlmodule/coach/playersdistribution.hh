...
#ifndef PLAYERSDISTRIBUTION_HH
#define PLAYERSDISTRIBUTION_HH
...
public:
    PlayersDistribution(WRTeam *team, qint8 *kickerId, SSLGameInfo::RefProcessedState *lastState, SSLReferee *ref);
