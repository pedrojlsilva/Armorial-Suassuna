...
#include "vssstrategy_wr2015_gameon.hh"
#include <WRCoach/entity/controlmodule/coach/strategy/wrstrategystate.hh>

#pragma GCC diagnostic ignored "-Wunused-parameter"

QString VSSStrategy_WR2015_GameOn::name() {
	return "VSSStrategy_WR2015_GameOn";
}

VSSStrategy_WR2015_GameOn::VSSStrategy_WR2015_GameOn() {
	_pb_attack = NULL;
	_pb_defense = NULL;
	_pb_goal = NULL;
}
...
void VSSStrategy_WR2015_GameOn::configure(int numOurPlayers) {
...
void VSSStrategy_WR2015_GameOn::run(int numOurPlayers) {
	// Solo (GK-attacker)
	if(numOurPlayers == 1) {
