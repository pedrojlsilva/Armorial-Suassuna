...
#include "sslstrategy_wr2015_ourindirectkick.hh"
#include <WRCoach/entity/controlmodule/coach/strategy/wrstrategystate.hh>

#pragma GCC diagnostic ignored "-Wunused-parameter"

QString SSLStrategy_WR2015_OurIndirectKick::name() {
	return "SSLStrategy_WR2015_OurIndirectKick";
}

SSLStrategy_WR2015_OurIndirectKick::SSLStrategy_WR2015_OurIndirectKick() {
    _pb_goal = NULL;
    _pb_atk = NULL;
    _pb_defense = NULL;
}

void SSLStrategy_WR2015_OurIndirectKick::configure(int numOurPlayers) {
...
void SSLStrategy_WR2015_OurIndirectKick::run(int numOurPlayers) {
    // ADD PLAYERS
